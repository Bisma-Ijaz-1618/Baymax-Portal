...
const AttendCallScreen = ({ id }) => {
  ...
  //     id: "662a8c2ba721c176bc1bf7bd",
  //     formData: {
  //       status: "completed", // Update the status field to 'completed'
  //       startTime: new Date(), // Update the startTime field to the current date and time
  //       endTime: new Date("2024-05-01T12:00:00Z"), // Update the endTime field to a specific date and time
  //       details: "Updated appointment details", // Update the details field
  //     },
  //   });
  // }, []);
